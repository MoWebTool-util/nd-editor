...
module.exports = function() {
  ...
  host.on('viewChange', function(state) {
    host.enableButton('bold', state === 'wysiwyg');
    host.enableButton('italic', state === 'wysiwyg');
    host.enableButton('underline', state === 'wysiwyg');
    host.enableButton('strikethrough', state === 'wysiwyg');
    host.enableButton('mark', state === 'wysiwyg');
    host.enableButton('subscript', state === 'wysiwyg');
    host.enableButton('supscript', state === 'wysiwyg');
  });
