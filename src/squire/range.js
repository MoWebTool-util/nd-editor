...
Range.prototype = {
  ...
  setSelection: function(range, store) {
    if (range) {
      if (store) {
        return (this._lastSelection = range);
      }
  ...
  getSelection: function() {
    ...
    if (sel.rangeCount) {
      ...
      if (startContainer && endContainer &&
        startContainer.nodeType === env.TEXT_NODE &&
        endContainer.nodeType === env.ELEMENT_NODE) {
        var node = endContainer.previousSibling;
